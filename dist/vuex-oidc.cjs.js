...
var oidc__default = _interopDefault(oidc);
...
var defaultOidcConfig = {
  userStore: new oidc__default.WebStorageStateStore(),
  loadUserInfo: true,
...
var createOidcUserManager = function createOidcUserManager(oidcSettings) {
  ...
  return new oidc__default.UserManager(oidcConfig);
};
...
var processSilentSignInCallback = function processSilentSignInCallback() {
  return new oidc__default.UserManager().signinSilentCallback();
};
...
var createStoreModule = (function (oidcSettings) {
  ...
  */
  ...
  function signinEndWithForcedLogout(_x) {
    return _signinEndWithForcedLogout.apply(this, arguments);
  }

  function _signinEndWithForcedLogout() {
    _signinEndWithForcedLogout = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url) {
      var args,
          signinResponse,
          identityProvider,
          params,
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              identityProvider = signinResponse.profile.preferred_username.split('.')[0];
              ...
              redirectUrl = oidcSettings.logoutUrl + '?' + params.toString();
            ...
            case 12:
              user = new oidc.User(signinResponse);
