...
var oidc = _interopDefault(require('oidc-client'));
var vue = require('vue');
...
var createReactiveState = (function (oidcSettings) {
  ...
  var getters = {
    oidcIsAuthenticated: vue.computed(function () {
      return isAuthenticated(state);
    }),
    oidcUser: vue.computed(function () {
      return state.user;
    }),
    oidcAccessToken: vue.computed(function () {
      return tokenIsExpired(state.access_token) ? null : state.access_token;
    }),
    oidcAccessTokenExp: vue.computed(function () {
      return tokenExp(state.access_token);
    }),
    oidcScopes: vue.computed(function () {
      return state.scopes;
    }),
    oidcIdToken: vue.computed(function () {
      return tokenIsExpired(state.id_token) ? null : state.id_token;
    }),
    oidcIdTokenExp: vue.computed(function () {
      return tokenExp(state.id_token);
    }),
    oidcRefreshToken: vue.computed(function () {
      return tokenIsExpired(state.refresh_token) ? null : state.refresh_token;
    }),
    oidcRefreshTokenExp: vue.computed(function () {
      return tokenExp(state.refresh_token);
    }),
    oidcAuthenticationIsChecked: vue.computed(function () {
      return state.is_checked;
    }),
    oidcError: vue.computed(function () {
      return state.error;
    })
  };
  var mutations = {
  ...
  var reactiveState = _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, stateSettings), vue.toRefs(state)), getters), methods);
...
exports.vuexOidcCreateReactiveState = vuexOidcCreateReactiveState;
exports.vuexOidcCreateReactiveStateRouterMiddleware = vuexOidcCreateReactiveStateRouterMiddleware;
